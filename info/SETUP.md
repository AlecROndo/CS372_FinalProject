...
The deep learning model is in `models_data/FinalProject (8).ipynb` and is designed to run on Google Colab with GPU support.

1. Upload `kalshi_data/`, `backtester_data/`, `new_btc_data.nc`, and `btc_back.nc` to your Google Drive
...
├── kalshi_data/                # Collected market data (.nc files)
