...
btcdata = xr.open_dataset(os.path.join(_ROOT, "btcdata", "new_btc_data.nc"))
data = {
    f.replace(".nc", ""): xr.open_dataset(os.path.join(_ROOT, "kalshi_data", f))
    for f in os.listdir(os.path.join(_ROOT, "kalshi_data")) if f.endswith(".nc")
}
